...
if(isset($_POST['submit'])){
    ...
    if(mysqli_num_rows(mysqli_query($con,"select id from services_request where student_id='$user_id' and type='$type'"))>0){
        $msg='<div class="alert alert-danger col-lg-12" role="alert">
                Services already applied.
            </div>';
    }else{
        echo $sql="INSERT INTO `services_request` (`id`, `student_id`, `type`, `reason`, `public_access`,  `added_on`, `status`) VALUES 
