...
if(isset($_GET['type']) && $_GET['type']!=='' && isset($_GET['id']) && $_GET['id']>0){
	...
	if($type=='active' || $type=='deactive'){
		...
		mysqli_query($con,"update self set status='$status' where id='$id'");
        redirect('./selfs.php');
	}

}
$sql="select * from self order by id desc";
            ...
            <div class="heading-layout1">
                ...
                <div class="dropdown show">
                    <div class="col-12 form-group mg-t-8">
                        <a href="manage_self"> <button type="submit"
                                class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Add new Book Self</button>
                        </a>
                    </div>
                </div>
            </div>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="manage_self.php?id=<?php echo $row['id']?>"><i
